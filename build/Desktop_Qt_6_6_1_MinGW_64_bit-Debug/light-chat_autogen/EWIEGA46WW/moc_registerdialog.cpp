...
Q_CONSTINIT static const qt_meta_stringdata_CLASSRegisterDialogENDCLASS_t qt_meta_stringdata_CLASSRegisterDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(15, 23),  // "on_get_code_btn_clicked"
        QT_MOC_LITERAL(39, 0),  // ""
        QT_MOC_LITERAL(40, 24),  // "slot_register_mod_finish"
        QT_MOC_LITERAL(65, 9),  // "RequestId"
...
Q_CONSTINIT const QMetaObject RegisterDialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRegisterDialogENDCLASS_t,
        ...
        // method 'slot_register_mod_finish'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void RegisterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_get_code_btn_clicked(); break;
        case 1: _t->slot_register_mod_finish((*reinterpret_cast< std::add_pointer_t<RequestId>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<ErrorCodes>>(_a[3]))); break;
        default: ;
        }
    }
}
